...
//int ObjectLoader::LoadObjVertFromFile(string obj_name, std::vector<Vertex>& a_vertecies, std::vector<GLint>& a_indicies)
//{
//	string filepath = m_objFilePath + obj_name + ".obj";
//
//	const C_STRUCT aiScene* tmpScene = aiImportFile(filepath.c_str(),
...
//
//	if (tmpScene == nullptr) {
//		std::cout << "Error in Loading Obj: " << obj_name << std::endl;
//		return -1;
//	}
//
//	a_vertecies.clear();
...
//
//		a_vertecies.push_back(Vertex());
//		a_vertecies[i].pos = glm::vec3(position.x, position.y, position.z);
//	}
//
...
//			a_vertecies[i].normal = glm::vec3(normal.x, normal.y, normal.z);
//		}
//	}
//
//	//Tex Coords
...
//			a_vertecies[i].uvs = glm::vec2(texCoords.x, texCoords.y);
//		}
//	}
//	//Tangents
...
//			a_vertecies[i].tangents = glm::vec3(tangents.x, tangents.y, tangents.z);
//		}
//	}
//
//	//BiTangents
...
//			a_vertecies[i].bitangents = glm::vec3(biTangents.x, biTangents.y, biTangents.z);
//		}
//	}
//
//	//Indicies
...
//		a_indicies.push_back(face.mIndices[0]);
//		a_indicies.push_back(face.mIndices[1]);
//		a_indicies.push_back(face.mIndices[2]);
//	}
//	return 0;
//
//}
...
//int ObjectLoader::LoadMaterialFromFile(string a_matName, Material& a_material)
//{
//	string filepath = m_objFilePath + a_matName + ".obj";
//
//	const C_STRUCT aiScene* tmpScene = aiImportFile(filepath.c_str(),
//		aiProcess_Triangulate |
//		aiProcess_JoinIdenticalVertices |
